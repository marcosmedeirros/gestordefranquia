<?php
/**
 * THE JOURNEY — simulador de carreira no basquete.
 *
...
<title>The Journey — FBA Games</title>
...
// Reserva: no site, thejourney.php injeta os times de verdade com o logo
...
/**
 * A lista de times da liga escolhida. No site, thejourney.php injeta os da
...
function topo(){
  ...
  return `<div class="topbar">
    <div class="topbar-left">
      ...
      <span class="game-title">The <span>Journey</span><span class="daily-badge">carreira</span></span>
    </div>
...
function cartaoDeCarreira(pts, tot, anos){
  ...
  return `<div class="cartao" style="--c1:${d.c1};--c2:${d.c2}">
    ...
    <div class="ct-pe">FBA Games · The Journey · ${esc(d.nome)}</div>
  </div>`;
}
