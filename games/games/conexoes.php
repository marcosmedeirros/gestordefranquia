...
$PUZZLES = [
    ...
    // 14
    [
        ['cor'=>'green',  'label'=>'Artilheiros históricos (60s–70s)',
         'dica'=>'Lideraram a NBA em pontos por jogo nas décadas de 1960 e 1970',
         'jogadores'=>['Wilt Chamberlain','Rick Barry','Bob McAdoo','George Gervin']],
        ['cor'=>'yellow', 'label'=>'Detroit Pistons "Bad Boys"',
         'dica'=>'Peças-chave dos bicampeões do Detroit Pistons 1989–90',
         'jogadores'=>['Isiah Thomas','Joe Dumars','Dennis Rodman','Bill Laimbeer']],
        ['cor'=>'red',    'label'=>'Campeões New York Knicks 1970 e 1973',
         'dica'=>'Conquistaram títulos com os Knicks nos anos 70',
    ...
    // 15
    [
        ['cor'=>'green',  'label'=>'Utah Jazz lendas',
         'dica'=>'Os maiores nomes da história do Utah Jazz',
         'jogadores'=>['John Stockton','Karl Malone','Adrian Dantley','Pete Maravich']],
        ['cor'=>'yellow', 'label'=>'Portland Trail Blazers ícones',
         'dica'=>'Moldaram a história do Portland Trail Blazers',
         'jogadores'=>['Bill Walton','Clyde Drexler','Damian Lillard','Brandon Roy']],
        ['cor'=>'red',    'label'=>'Jogadores com MVP sem anel — era clássica',
         'dica'=>'Foram premiados MVP da temporada mas nunca conquistaram o título',
         'jogadores'=>['Oscar Robertson','Elvin Hayes','Bob McAdoo','George Gervin']],
        ['cor'=>'purple', 'label'=>'Indianapolis/Indiana Pacers ícones',
         'dica'=>'Definiram a história dos Indiana Pacers',
         'jogadores'=>['Reggie Miller','Rik Smits','Jermaine O\'Neal','Paul George']],
    ],
    // 16
    [
        ['cor'=>'green',  'label'=>'Australianos na NBA',
         'dica'=>'Jogadores nascidos na Austrália',
         'jogadores'=>['Andrew Bogut','Patty Mills','Ben Simmons','Joe Ingles']],
        ['cor'=>'yellow', 'label'=>'Detroit Pistons campeões 2004',
         'dica'=>'Peças-chave do Detroit Pistons campeão de 2004',
         'jogadores'=>['Chauncey Billups','Ben Wallace','Richard Hamilton','Rasheed Wallace']],
        ['cor'=>'red',    'label'=>'Golden State Warriors — Splash Brothers era',
         'dica'=>'Definiram o Golden State Warriors bicampeão 2017–2018',
         'jogadores'=>['Stephen Curry','Klay Thompson','Kevin Durant','Draymond Green']],
        ['cor'=>'purple', 'label'=>'Pick #1 geral em diferentes décadas',
         'dica'=>'Foram selecionados como primeira escolha geral do Draft em décadas diferentes',
         'jogadores'=>['Magic Johnson','Patrick Ewing','Allen Iverson','LeBron James']],
    ],
    // 17
    [
        ['cor'=>'green',  'label'=>'Croatas na NBA',
         'dica'=>'Jogadores nascidos na Croácia',
         'jogadores'=>['Drazen Petrovic','Toni Kukoc','Dino Radja','Bojan Bogdanovic']],
        ['cor'=>'yellow', 'label'=>'Sacramento Kings era dourada (1999–2006)',
         'dica'=>'Formaram o poderoso Sacramento Kings no início dos anos 2000',
         'jogadores'=>['Chris Webber','Peja Stojakovic','Mike Bibby','Vlade Divac']],
        ['cor'=>'red',    'label'=>'MVP consecutivos (2+ vezes seguidas)',
         'dica'=>'Venceram o MVP da temporada ao menos duas vezes consecutivas',
         'jogadores'=>['Bill Russell','Magic Johnson','LeBron James','Giannis Antetokounmpo']],
        ['cor'=>'purple', 'label'=>'Lendas da Golden State dos anos 70',
         'dica'=>'Conquistaram ou definiram o Golden State Warriors na era pré-moderna',
         'jogadores'=>['Rick Barry','Nate Thurmond','Alvin Attles','Phil Smith']],
    ],
    // 18
    [
        ['cor'=>'green',  'label'=>'Orlando Magic ícones',
         'dica'=>'Jogadores marcantes da história do Orlando Magic',
         'jogadores'=>["Shaquille O'Neal",'Penny Hardaway','Dwight Howard','Tracy McGrady']],
        ['cor'=>'yellow', 'label'=>'Chicago Bulls campeões (1991–93)',
         'dica'=>'Fizeram parte do tricampeonato do Bulls de 1991 a 1993',
         'jogadores'=>['Michael Jordan','Scottie Pippen','Horace Grant','B.J. Armstrong']],
        ['cor'=>'red',    'label'=>'Melhor Defensor (DPOY) — era clássica',
         'dica'=>'Venceram o DPOY entre 1983 e 1995',
         'jogadores'=>['Sidney Moncrief','Alvin Robertson','Dennis Rodman','Dikembe Mutombo']],
        ['cor'=>'purple', 'label'=>'Nomes com #1 no Draft e campeões',
         'dica'=>'Foram primeira escolha do Draft e venceram ao menos um título na carreira',
         'jogadores'=>['Magic Johnson','Tim Duncan','Kyrie Irving','Andrew Bogut']],
    ],
    // 19
    [
        ['cor'=>'green',  'label'=>'Memphis Grizzlies "Grit and Grind"',
         'dica'=>'Definição do estilo Grit & Grind do Memphis Grizzlies',
         'jogadores'=>['Marc Gasol','Zach Randolph','Mike Conley','Tony Allen']],
        ['cor'=>'yellow', 'label'=>'Rookies do Ano — Nova Geração (2019–2024)',
         'dica'=>'Venceram o Rookie of the Year entre 2019 e 2024',
         'jogadores'=>['Zion Williamson','LaMelo Ball','Scottie Barnes','Paolo Banchero']],
        ['cor'=>'red',    'label'=>'Jogadores que atuaram no Seattle SuperSonics',
         'dica'=>'Foram figuras marcantes do saudoso Seattle SuperSonics',
         'jogadores'=>['Gary Payton','Kevin Durant','Jack Sikma','Shawn Kemp']],
        ['cor'=>'purple', 'label'=>'NBA 75 — os maiores de todos os tempos',
         'dica'=>'Selecionados entre os 75 maiores jogadores da história da NBA',
         'jogadores'=>['Oscar Robertson','Pete Maravich','Bob McAdoo','George Gervin']],
    ],
    // 20
    [
        ['cor'=>'green',  'label'=>'Washington Bullets/Wizards lendas',
         'dica'=>'Nomes icônicos do franchise de Washington ao longo das décadas',
         'jogadores'=>['Elvin Hayes','Wes Unseld','Gilbert Arenas','John Wall']],
        ['cor'=>'yellow', 'label'=>'Draft Class 1992',
         'dica'=>'Foram selecionados no histórico Draft de 1992',
         'jogadores'=>["Shaquille O'Neal",'Alonzo Mourning','Robert Horry','Christian Laettner']],
        ['cor'=>'red',    'label'=>'Lituanos na NBA',
         'dica'=>'Jogadores nascidos na Lituânia',
