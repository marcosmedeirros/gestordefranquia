        ...
        <section id="section-store" class="hidden text-center">
            ...
            <div class="flex flex-wrap justify-center gap-8 mt-10">
                <div class="flex flex-col items-center">
                    <div id="pack-daily" class="pack w-64 h-80 rounded-xl relative flex flex-col justify-center items-center overflow-hidden" style="background:linear-gradient(135deg,#1f2937,#0f172a)" onclick="claimDailyPack()">
