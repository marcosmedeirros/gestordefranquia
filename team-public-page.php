...
<head>
    ...
    <style>
        :root {
            ...
            --red-soft:  color-mix(in srgb, var(--red) 10%, transparent); --red-glow:color-mix(in srgb, var(--red) 18%, transparent);
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .module-item-row{display:flex;gap:10px;align-items:center;padding:10px 14px;}
        ...
        .form-control:focus,.form-select:focus{border-color:var(--red)!important;box-shadow:0 0 0 3px color-mix(in srgb, var(--red) 12%, transparent)!important;}
        ...
        .mode-tab{padding:8px 16px;border-radius:var(--radius-sm);border:1px solid var(--border);background:var(--panel-2);color:var(--text-2);font-family:var(--font);font-size:13px;font-weight:600;cursor:pointer;transition:all var(--t) var(--ease);display:flex;align-items:center;gap:6px;}
        ...
        .font-option{display:flex;flex-direction:column;align-items:center;gap:6px;padding:12px 6px 10px;border:1px solid var(--border);border-radius:var(--radius-sm);cursor:pointer;background:var(--panel-2);transition:all var(--t) var(--ease);user-select:none;}
        .font-option:hover{border-color:var(--border-md);background:var(--panel-3);}
        .font-option.selected{border-color:var(--red);background:color-mix(in srgb, var(--red) 8%, transparent);}
                        ...
                        <div class="bc">
                            ...
                            <div class="bc-body">
                                <p style="font-size:12px;color:var(--text-2);margin-bottom:12px">
                                    As variáveis CSS <code style="background:var(--panel-3);padding:1px 6px;border-radius:4px;font-size:11px">--p</code> (cor primária) e <code style="background:var(--panel-3);padding:1px 6px;border-radius:4px;font-size:11px">--s</code> (secundária) estão disponíveis no seu HTML.
                                </p>
