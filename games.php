...
$statusDiario = [
    ...
    'buildplayer'=> jogouHoje($pdo, "SELECT 1 FROM buildplayer_partidas WHERE id_usuario=? AND data_jogo=? LIMIT 1", [$userId, $hoje]),
];
...
$jogosDiarios = [
    ...
    ['key' => 'buildplayer','nome' => 'Build a Player','sub' => 'Monte e simule',      'icone' => 'bi-tools',             'cor' => '#a855f7'],
];
$jogosLivres = [
