...
<div class="app">
    <!-- ══════════════════════════════════════════════
         SIDEBAR E TOPBAR (Idênticos ao Dashboard)
    ══════════════════════════════════════════════ -->
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sb-team">
            <img src="<?= htmlspecialchars($team['photo_url'] ?? '/img/default-team.png') ?>" 
                 alt="Time" onerror="this.src='/img/default-team.png'">
            <div>
                <div class="sb-team-name"><?= htmlspecialchars(($team['city'] ?? '') . ' ' . ($team['name'] ?? '')) ?></div>
                <div class="sb-team-league"><?= htmlspecialchars($user['league'] ?? 'ELITE') ?></div>
            </div>
        </div>
        ...
        <div class="sb-footer">
            <img src="<?= htmlspecialchars($user['photo_url'] ?? 'https://ui-avatars.com/api/?name='.rawurlencode($user['name']).'&background=1c1c21&color=fc0025') ?>" class="sb-avatar" onerror="this.src='https://ui-avatars.com/api/?name=User'">
