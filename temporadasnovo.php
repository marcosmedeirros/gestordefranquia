...
<head>
  ...
  <style>
    :root { --red:#fc0025; --red-soft:rgba(252,0,37,.1); --bg:#07070a; --panel:#101013; --panel-2:#16161a; --panel-3:#1c1c21; --border:rgba(255,255,255,.08); --text:#f0f0f3; --text-2:#9a9aa2; --sidebar-w:260px; --font:'Poppins',sans-serif; }
    :root[data-theme="light"] { --bg:#f5f6fa; --panel:#fff; --panel-2:#f7f8fb; --panel-3:#f0f2f7; --border:rgba(20,20,30,.12); --text:#111318; --text-2:#636a77; }
    *{box-sizing:border-box} body{margin:0;background:radial-gradient(1000px 500px at 100% -10%,rgba(252,0,37,.12),transparent 60%),radial-gradient(900px 420px at -10% 0%,rgba(252,0,37,.08),transparent 55%),var(--bg);color:var(--text);font-family:var(--font)}
    .app{min-height:100vh}
    .sidebar{position:fixed;inset:0 auto 0 0;width:var(--sidebar-w);background:linear-gradient(180deg,var(--panel) 0%,#0d0d11 100%);border-right:1px solid var(--border);z-index:1000;padding:18px 14px 12px;display:flex;flex-direction:column;gap:14px;overflow-y:auto;transition:transform .2s ease}
    .sb-brand{display:flex;align-items:center;gap:10px;padding:6px 8px}.sb-logo{width:34px;height:34px;border-radius:10px;background:var(--red);display:grid;place-items:center;color:#fff;font-weight:800;font-size:12px}.sb-brand-text{font-weight:700;line-height:1.1;font-size:14px}.sb-brand-text span{display:block;color:var(--text-2);font-size:11px;font-weight:500;margin-top:2px}
    .sb-team{display:flex;align-items:center;gap:10px;padding:10px;border:1px solid var(--border);border-radius:12px;background:var(--panel-2)} .sb-team img{width:38px;height:38px;border-radius:10px;object-fit:cover;border:1px solid var(--border)} .sb-team-name{font-size:12px;font-weight:600;line-height:1.2} .sb-team-league{font-size:10px;color:var(--text-2);text-transform:uppercase;letter-spacing:.08em;margin-top:2px}
    .sb-season{display:flex;justify-content:space-between;gap:8px;padding:10px;border:1px solid var(--border);border-radius:12px;background:var(--panel-2)} .sb-season-label{font-size:10px;text-transform:uppercase;letter-spacing:.08em;color:var(--text-2)} .sb-season-val{font-size:13px;font-weight:700;margin-top:2px}
    .sb-nav{display:flex;flex-direction:column;gap:4px}.sb-section{margin-top:10px;margin-bottom:4px;padding:0 10px;font-size:10px;font-weight:700;color:var(--text-2);letter-spacing:.08em;text-transform:uppercase}
    .sb-nav a{display:flex;align-items:center;gap:10px;padding:9px 10px;border-radius:10px;color:var(--text);text-decoration:none;font-size:13px;border:1px solid transparent}.sb-nav a:hover{background:var(--panel-2);border-color:var(--border)}.sb-nav a.active{background:var(--red-soft);border-color:rgba(252,0,37,.3);color:#fff}.sb-nav a i{width:16px;text-align:center}
    .sb-theme-toggle{margin-top:auto;display:flex;align-items:center;justify-content:center;gap:8px;width:100%;border:1px solid var(--border);border-radius:10px;background:var(--panel-2);color:var(--text);padding:8px 10px;font-size:12px;font-weight:600}
    .sb-footer{display:flex;align-items:center;gap:10px;padding:8px;border-radius:10px;border:1px solid var(--border);background:var(--panel-2)}.sb-avatar{width:28px;height:28px;border-radius:999px;object-fit:cover;border:1px solid var(--border)}.sb-username{flex:1;min-width:0;font-size:12px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.sb-logout{color:var(--text-2);font-size:16px;text-decoration:none}
    .sb-overlay{position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:999;opacity:0;visibility:hidden;transition:.2s}.sb-overlay.show{opacity:1;visibility:visible}
    .topbar{position:fixed;inset:0 0 auto 0;height:54px;display:none;align-items:center;gap:10px;padding:0 12px;background:rgba(16,16,19,.95);backdrop-filter:blur(10px);border-bottom:1px solid var(--border);z-index:998}
    .menu-btn{width:34px;height:34px;border-radius:8px;border:1px solid var(--border);background:var(--panel-2);color:var(--text);display:grid;place-items:center}.topbar-title{font-size:13px;font-weight:700;color:var(--text)}.topbar-title em{font-style:normal;color:var(--red)}
    .main{margin-left:var(--sidebar-w);width:calc(100% - var(--sidebar-w));min-height:100vh;padding:26px 24px 32px}
    .page-shell{max-width:1200px;margin:0 auto;padding:20px;border:1px solid var(--border);border-radius:18px;background:linear-gradient(180deg,var(--panel) 0%,var(--panel-2) 100%)}.page-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:18px;padding-bottom:14px;border-bottom:1px solid var(--border)}
    .page-kicker{font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:var(--text-2);font-weight:700}.page-title{margin:4px 0 0;font-size:28px;font-weight:800}.page-sub{margin:6px 0 0;font-size:13px;color:var(--text-2)}
    .text-orange{color:var(--red)!important}.text-light-gray{color:var(--text-2)!important}.bg-dark-panel{background:var(--panel-2)!important}.border-orange{border:1px solid rgba(252,0,37,.25)!important}.bg-gradient-orange{background:linear-gradient(135deg,#fc0025,#ff3b57)!important;color:#fff}
    .league-card{border:1px solid var(--border);background:var(--panel-2);border-radius:14px;padding:18px;transition:.2s;height:100%}.league-card:hover{transform:translateY(-2px);border-color:rgba(252,0,37,.28);background:var(--panel-3)}.league-card h3{font-size:20px;margin:0 0 8px;font-weight:800}
    .btn-orange{background:var(--red);border-color:var(--red);color:#fff}.btn-orange:hover{background:#e00021;border-color:#e00021;color:#fff}.btn-outline-orange{border-color:var(--red);color:var(--red)}.btn-outline-orange:hover{background:var(--red);border-color:var(--red);color:#fff}.btn-back{border:1px solid var(--border);background:var(--panel-2);color:var(--text)}.btn-back:hover{border-color:rgba(252,0,37,.28);color:var(--text)}
    .table{color:var(--text)!important}.table-dark{--bs-table-bg:transparent;--bs-table-striped-bg:rgba(255,255,255,.02)}.form-control,.form-select{background:var(--panel-2);border-color:var(--border);color:var(--text)}.form-control:focus,.form-select:focus{border-color:rgba(252,0,37,.4);box-shadow:0 0 0 .2rem rgba(252,0,37,.12);background:var(--panel-2);color:var(--text)}
    .alert{border-radius:12px}
    @media (max-width:860px){:root{--sidebar-w:0px}.sidebar{transform:translateX(-260px)}.sidebar.open{transform:translateX(0)}.main{margin-left:0;width:100%;padding:62px 14px 20px}.topbar{display:flex}.page-shell{padding:14px;border-radius:14px}.page-title{font-size:22px}}
  </style>
</head>
<body>
