    ...
    <nav className="nav">
      <div className="wrap nav-inner">
        ...
        <div className="nav-links">
          ...
          <a href="#pathetic">The Pathetic</a>
...
function Divisions() {
  const ITEMS = [
    {
      id: "games",
      name: "Games",
      tag: "Modos extras · Em breve",
      desc: "Games paralelos dentro da FBA. Jogue e acumule pontos para o seu time ao longo da temporada.",
      color: "#2A6FDB",
    },
    {
      id: "pathetic",
      name: "The Pathetic",
      tag: "Jornal da liga · Em breve",
  ...
  return (
    <section className="section divisions" id="divisions">
      <div className="wrap">
        <div className="section-head">
          <span className="section-num">03 / Em breve</span>
...
function HowItWorks() {
  return (
    <section className="section how" id="how">
      <div className="wrap">
        <div className="section-head">
          <span className="section-num">02 / Formato</span>
          <h2>Como<br />Funciona.</h2>
          <a className="section-link" href="#games">Games →</a>
        </div>
...
function Champions() {
  return (
    <section className="section champs" id="champions">
      <div className="wrap">
        <div className="section-head">
          <span className="section-num">04 / Histórico</span>
          <h2>Campeões.</h2>
          <a className="section-link" href="#">Hall of fame →</a>
        </div>
