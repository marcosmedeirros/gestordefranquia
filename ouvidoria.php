...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .field-footer { display: flex; justify-content: space-between; align-items: center; margin-top: 8px; }
        .field-hint { font-size: 11px; color: var(--text-3); display: flex; align-items: center; gap: 6px; }
        ...
        .msg-alert.danger  { background: color-mix(in srgb, var(--red) 10%, transparent);  border-color: color-mix(in srgb, var(--red) 25%, transparent);  color: #ff6b7a; display: flex; align-items: center; gap: 8px; }
