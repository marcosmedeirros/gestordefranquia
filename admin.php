...
<body>
  ...
  <div class="dashboard-content">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1 class="text-white fw-bold mb-0"><i class="bi bi-shield-lock-fill me-2 text-orange"></i>Admin - Ligas</h1>
      <button class="btn btn-orange" id="saveAllBtn"><i class="bi bi-save2 me-1"></i>Salvar Caps</button>
    </div>
