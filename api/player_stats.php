...
if ($action === 'save_snapshot') {
    // A regra mora em backend/snapshot_temporada.php — o controle de elencos
    // do admin congela a temporada do mesmo jeito, e duas cópias seriam duas
    // histórias diferentes do mesmo jogador.
    require_once __DIR__ . '/../backend/snapshot_temporada.php';
    $snap = snapshotTemporadaDoTime($pdo, $teamId, $season, $league);
    if (!$snap['ok']) {
        http_response_code(500);
