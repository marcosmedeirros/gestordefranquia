        ...
        case 'leagues':
            ...
            foreach ($leagues as $league) {
                ...
                $result[] = [
                    ...
                    // O NOME DO ARQUIVO, e não o texto extraído dele. Vinham
                    // os dois de 'edital', que é o mediumtext do PDF lido — a
                    // tela mostrava o edital inteiro onde devia estar
                    // "elite_edital.pdf".
                    'edital_file' => $cfg['edital_file'] ?? '',
...
if ($method === 'POST') {
    ...
    switch ($action) {
        /* CALCULAR O CAP DA LIGA, agora, porque o admin mandou.
           Esta conta já rodava sozinha nas temporadas 3, 5, 7… no momento em
           que o último time salvava o elenco — e o CAP mudava no meio de um
           avanço de temporada, sem ninguém conferir. Virou botão. A conta é a
           mesma de sempre; o que mudou foi quem aperta. */
        case 'recalcular_cap': {
            ...
            echo json_encode(['success' => true, 'resumo' => $r['resumo']]);
            exit;
        }
