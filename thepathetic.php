...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tp-top-bar { height: 4px; background: linear-gradient(90deg, #fc0025, #ff6b35, #fc0025); background-size: 200%; animation: tpBar 3s linear infinite; }
        ...
        .tp-brand-logo { font-size: 11px; font-weight: 800; letter-spacing: 1.5px; text-transform: uppercase; color: #fc0025; border: 1px solid rgba(252,0,37,.35); border-radius: 6px; padding: 3px 8px; }
